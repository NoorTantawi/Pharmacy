...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LEGION;Database=HopeDecemberPharmacy;Trusted_Connection=True; User Id=sa;password=P@ssw0rd;Integrated Security=False; TrustServerCertificate=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.Property(e => e.Qualifications).HasMaxLength(50);
            ...
            modelBuilder.Entity<MedicineSupplier>(entity =>
            {
                ...
                entity.Property(e => e.ExpirayDate).HasColumnType("date");
